<nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="widgets.html"><i class="fa fa-flask"></i> <span class="nav-label">Employee Managment</span></a>
                    </li>
                    
                
                   <li class="active">
                        <a href="index.html"><i class="fa fa-th-large"></i> <span class="nav-label">System Managment</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse in" aria-expanded="true">
                            <li><a href="{{url('/department')}}">Department</a></li>
                            <li><a href="{{url('/divison')}}">Division</a></li>
                    ...
                    <li>
                        <a href="{{url('/user')}}"><i class="fa fa-diamond"></i> <span class="nav-label">User Managment</span></a>
                    </li>
