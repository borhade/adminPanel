                        ...
                        <div class="col-lg-12">
                            <div class="ibox ">
                                ...
                                <div class="ibox-content">
                                    <form method="post" action="{{route('state.update',['id'=>$state_tabledata[0]->state_id])}}">
                                        <input type="hidden" name="_method" value="PUT">
                                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                                        <div class="form-group  row"><label class="col-sm-2 col-form-label">State Name</label>
                                            <div class="col-sm-10">
                                          <input type="text" class="form-control" name="state_name" value="{{$state_tabledata[0]->state_name}}"></div>
                                        </div>
